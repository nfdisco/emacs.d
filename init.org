...
Read capture and structure templates from the ~templates~ file in the
Org directory.
...
Load AUCTeX manually.  This is necessary on Debian until bug [[https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=915327][915327]] is
fixed.
